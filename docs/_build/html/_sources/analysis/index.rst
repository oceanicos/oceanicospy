...
Hilbert and wavelet transforms, and Empirical Mode Decomposiction (EMD). These methods are useful not only for wind-wave analysis,
but also for other types of waves like infragravity waves (IG).
