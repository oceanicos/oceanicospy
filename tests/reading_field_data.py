...
ws_measurements = WeatherStation('/Users/franklinayala/Documents/oceanicospy/data/obs_data/')
ws_dataset = ws_measurements.get_clean_reecords()
print(ws_dataset)
plot_wind_rose(ws_dataset,out_dir,'weather_station')

r_waterlevel_sensor = ResistiveSensor('/Users/franklinayala/Documents/oceanicospy/data/obs_data/')
